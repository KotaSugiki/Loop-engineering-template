...
| ファイル                   | 誰が管理        | 役割                                             |
| -------------------------- | --------------- | ------------------------------------------------ |
| `loop.config.yaml`         | 👤 人間         | 言語・CLIツール・Git設定の一元管理               |
| `loop.bash`                | 👤 人間         | ループの実行制御・オーケストレーション           |
| `agent_prompt_template.md` | 👤 人間         | エージェントへのシステム指示・ルール定義         |
| `SKILL.md`                 | 👤 人間         | プロジェクトのビルド手順・コーディング規約       |
| `AGENT.md`                 | 🤖 エージェント | 発見したコマンド・過去のバグの教訓を記録         |
| `fix_plan.md`              | 🤖 エージェント | タスクの進捗を記録・更新                         |
...
# テンプレートファイルを既存プロジェクトにコピー
cd loop-engineering
cp loop.bash /path/to/your-project/
cp templates/loop.config.yaml /path/to/your-project/
cp templates/agent_prompt_template.md /path/to/your-project/
cp templates/SKILL.md /path/to/your-project/
cp templates/AGENT.md /path/to/your-project/
cp templates/fix_plan.md /path/to/your-project/
...
```bash
# このリポジトリからテンプレートをコピー
cp /path/to/loop-engineering/loop.bash ./
cp /path/to/loop-engineering/templates/loop.config.yaml ./
cp /path/to/loop-engineering/templates/agent_prompt_template.md ./
cp /path/to/loop-engineering/templates/SKILL.md ./
cp /path/to/loop-engineering/templates/AGENT.md ./
cp /path/to/loop-engineering/templates/fix_plan.md ./
